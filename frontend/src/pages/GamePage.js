      ...
      <header className="bg-bet-red text-white shadow-lg">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold">OK.Win</h1>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-yellow-700">
                  <strong>Database Connection Error:</strong> The game is displayed in view-only mode. 
                  Please check your MongoDB connection. See <a href="/MONGODB_ATLAS_FIX.md" className="underline">MONGODB_ATLAS_FIX.md</a> for help.
                </p>
              </div>
            </div>
          </div>
